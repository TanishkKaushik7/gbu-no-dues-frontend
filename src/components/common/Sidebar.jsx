...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <button
        className="md:hidden fixed top-4 left-4 z-[60] p-2.5 bg-blue-600 text-white rounded-xl shadow-md hover:bg-blue-700 transition-colors"
      ...
      {/* Sidebar Container */}
      <div 
        className={`fixed md:sticky top-0 h-screen w-72 bg-white border-r border-gray-200 text-gray-600 z-50 transition-transform duration-300 ease-in-out transform 
      ...
      >
        <div className="flex flex-col h-full overflow-hidden">
              ...
              {menuItems.map((item) => (
                <li key={item.id}>
                  ...
                  >
                    ...
                    <span className={`text-lg transition-colors ${activeItem === item.id ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-600'}`}>
                      {item.icon}
                    </span>
          ...
          <div className="p-4 mx-4 mb-4 rounded-2xl bg-gray-50 border border-gray-100 shrink-0">
