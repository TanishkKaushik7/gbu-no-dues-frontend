...
// Shared Components - Ensure these are copied into the DynamicDepartment folder
...
const DynamicDashboard = () => {
  ...
  // The backend uses the User's Token to determine which department's applications to return
  ...
  const handleAction = async (application, action, remarksIn) => {
        ...
        <main className="flex-1 overflow-y-auto overflow-x-hidden px-4 pb-4 pt-16 sm:p-6 lg:p-8">
          ...
          >
            ...
            <motion.div variants={itemVariants}>
              {/* ⭐ DYNAMIC TITLE FETCHED FROM USER OBJECT */}
              ...
              <p className="text-sm sm:text-base text-gray-600 mt-1 sm:mt-2 mb-2 sm:mb-4">
                Review and process student clearance requests for {user?.department_name || 'your department'}.
              </p>
            </motion.div>
