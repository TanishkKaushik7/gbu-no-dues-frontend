      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="w-full max-w-md bg-slate-900/40 backdrop-blur-2xl border border-slate-800 p-8 rounded-[2rem] relative group hover:border-cyan-500/40 transition-all duration-500 shadow-2xl hover:shadow-cyan-500/10 animate-float">
            ...
            <div className="relative w-32 h-32 mb-6 mx-auto">
              ...
              <img
                src={mentor.image}
                alt={mentor.name}
                className="relative w-full h-full rounded-full border-2 border-slate-700 group-hover:border-cyan-400/50 object-cover p-1 transition-colors duration-500"
              />
            </div>
            ...
            <div className="text-center relative z-10">
              ...
              <p className="text-cyan-400 text-xs font-bold mb-6 uppercase tracking-[0.2em]">
                {mentor.role}
              </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-6 justify-items-center">
          {team.map((member, idx) => (
            <div
              key={idx}
              className="group w-full max-w-sm bg-slate-900/30 backdrop-blur-xl border border-slate-800 hover:border-slate-600 p-6 rounded-3xl transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:bg-slate-800/40 flex flex-col items-center"
            >
              ...
              <div className="text-center flex-grow w-full">
                <h4 className="text-base font-bold mb-1 text-slate-200 group-hover:text-white transition-colors">
                  {member.name}
                </h4>
                ...
                <div className="flex justify-center gap-4 pt-4 border-t border-slate-800 group-hover:border-slate-700 transition-colors">
                  ...
                  {member.links.linkedin && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-slate-500 hover:text-[#0A66C2] transition-all hover:scale-110"
                    >
                  ...
                  {member.links.instagram && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-slate-500 hover:text-[#E1306C] transition-all hover:scale-110"
                    >
